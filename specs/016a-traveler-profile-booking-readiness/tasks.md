...
- [ ] T047 [P] [US3] Write failing plural/singular create/get/prefill response-shape matrix and masked-read tests in `apps/api/test/booking-intent.e2e-spec.ts`
...
- [ ] T050 [US3] Add canonical plural create/get actions and deprecated singular aliases with safe response parity and deprecation telemetry in `apps/api/src/booking-intent/booking-intent.controller.ts`
