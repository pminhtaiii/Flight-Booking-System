...
**Branch**: `007-cabin-passenger-enhancement` | **Date**: 2026-07-09 | **Spec**: [spec.md](file:///c:/Booking%20Systems/specs/007-cabin-passenger-enhancement/spec.md)
...
```text
specs/007-cabin-passenger-enhancement/
├── plan.md              # This file
