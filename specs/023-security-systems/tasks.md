...
- [ ] T010 Implement sanitized evidence writer and canary tests in `scripts/security/write-report.mjs` and `tests/security/report-privacy.test.mjs`; allowlist report fields and redact raw ZAP/corpus payloads before upload.
