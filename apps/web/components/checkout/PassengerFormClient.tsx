  ...
  const source =
    offerPassengers.length > 0
      ...
      : [
          ...
          ...Array.from({ length: flight.children || 0 }, () => ({
            id: '',
            type: 'CHILD' as const,
          })),
          ...Array.from({ length: flight.infants || 0 }, () => ({
            id: '',
...
export function PassengerFormClient({
  ...
  const [passengers, setPassengers] = useState<FormPassenger[]>(() =>
    initialPassengers(flight, offerPassengers),
  );
  ...
  const validate = (): boolean => {
    ...
    passengers.forEach((passenger, index) => {
      ...
      if (!passenger.dateOfBirth || !dateRegex.test(passenger.dateOfBirth))
      ...
      if (!/^\+\d{1,4}$/.test(passenger.phoneCountryCode.trim()))
        errors[`${index}-phoneCountryCode`] = 'Enter a valid country code';
      if (!/^\d{4,20}$/.test(passenger.phoneNumber.trim()))
        errors[`${index}-phoneNumber`] = 'Enter a valid phone number';
      if (passenger.nationality.trim() && passenger.nationality.trim().length !== 2)
        errors[`${index}-nationality`] = 'Nationality must be a 2-letter country code';
      if (passenger.issuingCountry.trim() && passenger.issuingCountry.trim().length !== 2)
        errors[`${index}-issuingCountry`] = 'Issuing Country must be a 2-letter country code';
    });
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (!readiness || !('ready' in readiness) || !readiness.ready) {
        throw new Error(
          'The server needs more passenger details before this booking can continue.',
        );
      }
      ...
      setError(
        submissionError instanceof Error
          ...
          : 'We could not continue this booking.',
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) => handleFieldChange(index, 'givenName', event.target.value)}
                className="form-input w-full mt-1"
              />
            </label>
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) => handleFieldChange(index, 'familyName', event.target.value)}
                className="form-input w-full mt-1"
              />
            </label>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) => handleFieldChange(index, 'dateOfBirth', event.target.value)}
                className="form-input w-full mt-1"
              />
            </label>
            <label className="block text-sm font-medium text-text-secondary">
            ...
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) => handleFieldChange(index, 'nationality', event.target.value)}
                className="form-input w-full mt-1 uppercase"
              />
            </label>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) => handleFieldChange(index, 'email', event.target.value)}
                className="form-input w-full mt-1"
              />
            </label>
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) =>
                  handleFieldChange(index, 'phoneCountryCode', event.target.value)
                }
                className="form-input w-full mt-1"
              />
            </label>
            <label className="block text-sm font-medium text-text-secondary">
              ...
              <input
                ...
                onChange={(event) => handleFieldChange(index, 'phoneNumber', event.target.value)}
                className="form-input w-full mt-1"
              />
            </label>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <label className="block text-sm font-medium text-text-secondary">
                ...
                <input
                  ...
                  onChange={(event) => handleFieldChange(index, 'documentType', event.target.value)}
                  className="form-input w-full mt-1"
                />
              </label>
              <label className="block text-sm font-medium text-text-secondary">
                ...
                <input
                  ...
                  onChange={(event) =>
                    handleFieldChange(index, 'passportNumber', event.target.value)
                  }
                  className="form-input w-full mt-1"
                />
              </label>
              <label className="block text-sm font-medium text-text-secondary">
                ...
                <input
                  ...
                  onChange={(event) =>
                    handleFieldChange(index, 'passportExpiry', event.target.value)
                  }
                  className="form-input w-full mt-1"
                />
              </label>
              <label className="block text-sm font-medium text-text-secondary">
                ...
                <input
                  ...
                  onChange={(event) =>
                    handleFieldChange(index, 'issuingCountry', event.target.value)
                  }
                  className="form-input w-full mt-1 uppercase"
                />
              </label>
