...
function mintClaimToken(userId, iat, secret = 'test-claim-token-secret') {
...
describe('Agent Gateway (E2E)', () => {
    ...
    beforeAll(async () => {
        ...
        jest.spyOn(duffel_service_1.DuffelService.prototype, 'searchFlights').mockImplementation(async (query) => {
            const offerRequest = {
                id: 'or_123',
                offers: [
                    {
