...
describe('Authentication (E2E)', () => {
    ...
    describe('POST /auth/register', () => {
        ...
        it('should reject registration if email is already taken with a safe 409 Conflict', async () => {
            await (0, supertest_1.default)(app.getHttpServer()).post('/auth/register').send(validRegistration).expect(201);
    ...
    describe('GET /auth/me', () => {
        ...
        let userId;
        beforeEach(async () => {
            const res = await (0, supertest_1.default)(app.getHttpServer()).post('/auth/register').send({
        ...
        it('should reject request when token is expired', async () => {
            ...
            const expiredToken = jwtService.sign({ id: userId, email: 'session@example.com' }, { expiresIn: '-1s' });
            await (0, supertest_1.default)(app.getHttpServer())
                .get('/auth/me')
