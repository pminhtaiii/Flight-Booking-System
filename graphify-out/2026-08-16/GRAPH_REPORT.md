# Graph Report - Booking Systems  (2026-08-16)

## Corpus Check
- 747 files · ~535,430 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6166 nodes · 9248 edges · 574 communities (424 shown, 150 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 375 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1a0b78f`
...
- [[_COMMUNITY_readPaymentReservation|readPaymentReservation]]
- [[_COMMUNITY_AncillarySelectionClient.tsx|AncillarySelectionClient.tsx]]
- [[_COMMUNITY_.create|.create]]
- [[_COMMUNITY_passport-expiry-backfill.controller.ts|passport-expiry-backfill.controller.ts]]
- [[_COMMUNITY_page.tsx|page.tsx]]
- [[_COMMUNITY_booking-intent.types.ts|booking-intent.types.ts]]
- [[_COMMUNITY_DuffelEventProcessor|DuffelEventProcessor]]
- [[_COMMUNITY_Phase 0  PR 1 — Baseline reconciliation and protected frontend foundation|Phase 0 / PR 1 — Baseline reconciliation and protected frontend foundation]]
- [[_COMMUNITY_Phase 3  PR 4 — Supplier synchronization transaction and concurrency|Phase 3 / PR 4 — Supplier synchronization transaction and concurrency]]
- [[_COMMUNITY_._astream|._astream]]
- [[_COMMUNITY_test_phase8c_privacy.py|test_phase8c_privacy.py]]
- [[_COMMUNITY_flights.controller.ts|flights.controller.ts]]
- [[_COMMUNITY_traveler-profile.types.ts|traveler-profile.types.ts]]
- [[_COMMUNITY_disruption-phase3.e2e-spec.js|disruption-phase3.e2e-spec.js]]
- [[_COMMUNITY_BookingStatusBadge.tsx|BookingStatusBadge.tsx]]
- [[_COMMUNITY_User Scenarios & Testing (mandatory)|User Scenarios & Testing *(mandatory)*]]
- [[_COMMUNITY_Feature 017 Phase 9C Python Read Tools & Privacy-Minimized Formatting Plan|Feature 017 Phase 9C: Python Read Tools & Privacy-Minimized Formatting Plan]]
- [[_COMMUNITY_booking-intent.service.spec.ts|booking-intent.service.spec.ts]]
- [[_COMMUNITY_layout.tsx|layout.tsx]]
- [[_COMMUNITY_CheckoutHandoffCard.tsx|CheckoutHandoffCard.tsx]]
- [[_COMMUNITY_BookingStatusBadge.tsx|BookingStatusBadge.tsx]]
- [[_COMMUNITY_ItineraryChangeSummary.tsx|ItineraryChangeSummary.tsx]]
- [[_COMMUNITY_safeReturnTarget.ts|safeReturnTarget.ts]]
- [[_COMMUNITY_Phase 4  PR 5 — Signed webhook receiver, durable inbox, and processor|Phase 4 / PR 5 — Signed webhook receiver, durable inbox, and processor]]
- [[_COMMUNITY_Phase 6  PR 7 — Traveller APIs, local read model, and cancellation integration|Phase 6 / PR 7 — Traveller APIs, local read model, and cancellation integration]]
- [[_COMMUNITY_Phase 7  PR 8 — Traveller booking disruption experience|Phase 7 / PR 8 — Traveller booking disruption experience]]
- [[_COMMUNITY_Project Structure|Project Structure]]
...
1. `PrismaService` - 181 edges
2. `DuffelService` - 68 edges
3. `NestJSClient` - 66 edges
4. `CacheService` - 53 edges
5. `AuditService` - 47 edges
6. `StripeService` - 46 edges
7. `get_settings()` - 45 edges
8. `AppModule` - 43 edges
9. `BookingService` - 36 edges
10. `ChatHandoffService` - 36 edges
...
- `mock_nestjs_client()` --indirect_call--> `NestJSClient`  [INFERRED]
  apps/agent/tests/test_handoff_nodes.py → apps/agent/src/agent/tools/nestjs_client.py
...
## Communities (574 total, 150 thin omitted)

### Community 0 - "NestJSClient"
Cohesion: 0.10
Nodes (16): OutputGuardrailConfig, Settings, enabled_config(), test_benchmark_output_pipeline_latency(), test_output_guardrail_config_custom(), test_output_guardrail_config_defaults(), test_session_lock_timing_defaults_and_override(), test_agent_config_defaults() (+8 more)
...
Cohesion: 0.16
Nodes (15): DuffelSegment, FlightConditionChangeBeforeDepartureDto, FlightConditionsDto, FlightDetailResponseDto, CabinMismatchDetail, FlightOfferDto, FlightSearchResponseMetaDto, FlightSegmentDto (+7 more)
...
Cohesion: 0.14
Nodes (8): AuthenticatedRequest, ChatController, BatchMessagesDto, CreateMessageDto, CreateSessionDto, ListMessagesQueryDto, ListSessionsQueryDto, UpdateSessionDto
...
Cohesion: 0.08
Nodes (6): enrichRedactedDuffelOrder(), DuffelOrder, PaymentCronService, PaymentRefundService, enrichRedactedDuffelOrder(), redactDuffelOrder()
...
Cohesion: 0.18
Nodes (5): GuardrailService, Validates an output chunk.                  Args:             chunk: The outp, Checks if the guardrail service is healthy and available.                  Ret, Validates the input message.                  Args:             message: The, Protocol
...
Cohesion: 0.05
Nodes (30): AppModule, ChatService, HttpExceptionFilter, DuffelConfirmedCancellation, DuffelRecoveredOrder, DuffelOfferRequest, bootstrap(), Transaction (+22 more)
...
Cohesion: 0.10
Nodes (15): DuffelCleanupService, app_module_1, cache_service_1, common_1, duffel_cleanup_service_1, duffel_service_1, http_exception_filter_1, jwt_1 (+7 more)
...
Cohesion: 0.14
Nodes (17): AuthenticatedRequest, BookingHandoffController, AttestationOffer, AttestationPayload, ChatHandoffSafeResolveResponse, ClaimedHandoffRow, firstFlightSegment(), handoffPassengers() (+9 more)
...
Cohesion: 0.09
Nodes (32): ChatTelemetry, dashboard_alert_contract(), _new_opaque_id(), Any, Allowlisted, value-free telemetry for the chat rollout.  This module deliberat, Return the maintained dashboard/alert contract for agent telemetry.      This, Raised when an event would exceed the chat telemetry contract., Map runtime tool names to a bounded, non-sensitive telemetry label. (+24 more)
...
Cohesion: 0.11
Nodes (14): MaskedPassengerSummary, PassengerSnapshotBuildInput, PassengerSnapshotBuildResult, ResolvedPassengerForSnapshot, SnapshotScope, internationalPassenger(), passenger(), EncryptionContext (+6 more)
...
Cohesion: 0.25
Nodes (8): BookingReadinessService, currentDateOnly(), httpError(), inlinePassenger(), isRecord(), profilePassenger(), BookingReadinessPassengerDto, BookingReadinessResponseDto

### Community 70 - "auth.spec.ts"
Cohesion: 0.05
Nodes (13): parseDuffelCancellationQuoteId(), serializeDuffelCancellationQuoteId(), mockOffersGet, mockOffersGetPriced, mockSeatMapsGet, DuffelService, mockConfirmCancellation, mockGetOrder (+5 more)
...
Cohesion: 0.11
Nodes (17): AcceptDisruptionResponseDto, AcknowledgeDisruptionResponseDto, AdminClearAttentionRequestDto, AdminDataQualityReportDto, AdminDisruptionDto, AdminDuffelWebhookEventDto, AdminResolveDisruptionRequestDto, AdminRetryWebhookEventRequestDto (+9 more)
...
### Community 79 - "agent"
Cohesion: 0.12
Nodes (10): JwtAuthGuard, assertCanonicalCreate(), AuthenticatedRequest, BookingIntentLegacyController, requestContext(), setSafeHeaders(), HandoffFastFailGuard, HandoffRequest (+2 more)
...
Cohesion: 0.33
Nodes (6): generateItineraryFingerprint(), serializeSegmentCanonical(), extractLocalDate(), normalizeDuffelOrder(), parseIsoDurationToMinutes(), DuffelPlace
...
Cohesion: 0.16
Nodes (6): Roles(), RolesGuard, AdminRefundController, RefundResolutionAction, refundResolutionActions, ResolveRefundDto

### Community 152 - "AuditService"
Cohesion: 0.06
Nodes (13): AuthController, AuthenticatedRequest, AuthService, LoginDto, RegisterDto, LockoutService, ActiveUser, JwtPayload (+5 more)
...
Cohesion: 0.14
Nodes (16): OutputGuardrailBlockedError, OutputGuardrailPipeline, Feeds a token into the pipeline, yielding any safe completed chunks., Raised when an output chunk fails safety validation., Orchestrates output safety validation using a layered pipeline., Flushes the remaining buffered tokens and validates the final chunk., Cancels and cleans up any background validation tasks., Maintains a sliding window of the last N tokens from the previous chunk (+8 more)
...
Cohesion: 0.20
Nodes (23): addDaysToParsedDate(), compareParsedDates(), determineScope(), evaluateContactSection(), evaluateCountryField(), evaluateDateOfBirth(), evaluateDocumentType(), evaluateEmail() (+15 more)
...
Cohesion: 0.10
Nodes (12): BookingReadinessInlineSourceDto, BookingReadinessPassengerSourceConstraint, BookingReadinessPassengerSourceDto, BookingReadinessRequestDto, BookingReadinessTravelerProfileSourceDto, HandoffSourceConstraint, hasOnlyKeys(), INLINE_SOURCE_KEYS (+4 more)
...
Cohesion: 0.13
Nodes (14): CABIN_KEYWORDS, PASSENGER_KEYWORDS, capitalizeCabinClass(), cleanIsoTime(), formatDuffelBaggageAllowance(), parseISODurationToMinutes(), AttestedFlightSearchDto, AttestedFlightSearchResponseDto (+6 more)
...
Cohesion: 0.05
Nodes (22): BookingAgentProjectionService, SafeBookingProjectionData, BookingWithRelations, AuthenticatedRequest, DisruptionController, TravellerDisruptionController, DisruptionService, normalizeFlightSegments() (+14 more)

### Community 255 - "devDependencies"
Cohesion: 0.11
Nodes (7): ALLOWED_TRANSITIONS, canTransition(), enforceTransition(), getPreDisputeStatus(), resolveDisputeStatus(), PaymentWebhookController, PaymentWebhookService
...
Cohesion: 0.16
Nodes (23): test_first_chunk_unsafe(), test_mid_stream_chunk_unsafe(), test_nestjs_persistence_fails(), get_auth_headers(), mock_nestjs_client(), MockStreamingLLM, parse_sse(), test_sse_action_handoff_disabled_flag() (+15 more)
...
Cohesion: 0.14
Nodes (21): JWTAuthMiddleware, Redis, RateLimitMiddleware, Middleware that enforces two-level rate limiting (burst limit and daily quota), make_token(), Operational Drill: /health endpoint reports degraded if Redis client is None or, Operational Drill: When Redis control plane is down, rate limiting must fail-clo, Operational Drill: If Redis client raises uninitialized RuntimeError or RedisUna (+13 more)

### Community 269 - "RateLimitMiddleware"
Cohesion: 0.14
Nodes (8): health_check(), Request, Perform a health check verification by checking NestJS, Redis, and NeMo Guardrai, validate_origin_middleware(), _handoff_event_stream(), main(), Exercise browser-shaped trace continuity through FastAPI into real NestJS., test_e2e_output_guardrail_pipeline_validation()
...
Cohesion: 0.12
Nodes (3): BookingIntentController, BookingIntentCron, BookingIntentService
...
Cohesion: 0.22
Nodes (10): BookingFailureState(), BookingFailureStateProps, chargeMessage(), failureMessages, BookingFailureReason, BookingStatus, BookingDetailDto, BookingListItemDto (+2 more)
...
Cohesion: 0.14
Nodes (14): Decisions Made, Q10 — Reconciliation Cron: Backup Only ✅, Q11 — Confidence-Based Segment Matching ✅, Q12 — Cancellation × Disruption Interaction ✅, Q13 — Sync Pipeline Failure Handling ✅, Q1 — Notification Outbox ✅, Q2 — Itinerary Revision Segment Storage ✅, Q3 — Disruption Status: Orthogonal Field ✅ (+6 more)
...
Cohesion: 0.12
Nodes (14): PassengerPageFlightDetail, Props, FormPassenger, PassengerFormClient(), PassengerFormClientProps, BookingIntentDto, BookingReadinessResponse, CheckoutPassengerRequest (+6 more)
...
Cohesion: 0.13
Nodes (5): AgentGatewayController, AgentGatewayService, AgentBookingReadinessPassengerDto, AgentBookingReadinessRequestDto, AgentBookingReadinessResponseDto
...
Cohesion: 0.17
Nodes (8): Further Notes, Implementation Decisions, Out of Scope, Problem Statement, Product Requirements Document: Disruption & Flight-Change Management, Solution, Testing Decisions, User Stories
...
Cohesion: 0.22
Nodes (17): AgentGatewayModule, AirportsModule, AncillariesModule, AuditModule, AuthModule, BookingModule, BookingIntentModule, CacheModule (+9 more)

### Community 327 - "paths"
Cohesion: 0.07
Nodes (32): AuditService, BookingService, StripeService, LeasedSnapshot, ValidateAncillaryPaymentInput, ValidatedAncillaryPayment, ValidationIntent, ConfirmPaymentDto (+24 more)
...
Cohesion: 0.14
Nodes (21): Action, ACTIONS, BookingActionCardProps, FIELD_NAMES, FieldName, isExactRecord(), isOneOf(), parseActionRequiredEvent() (+13 more)

### Community 343 - "Product Requirements Document: Cancellation & Refund Recovery"
Cohesion: 0.25
Nodes (8): Further Notes, Implementation Decisions, Out of Scope, Problem Statement, Product Requirements Document: Cancellation & Refund Recovery, Solution, Testing Decisions, User Stories
...
Cohesion: 0.13
Nodes (21): BookingReadinessEvaluator, buildPassengerResult(), normalizedDocumentTypes(), ParsedDate, passengerReady(), createInput(), createPassenger(), SUPPORTED_GENDERS (+13 more)
...
Cohesion: 0.16
Nodes (12): TrustedSearchSnapshot, Redis, Atomically replaces the old snapshot and sets the TTL based on expiresAt., Loads the snapshot and verifies owner/session match., Atomically delete the snapshot., TrustedSnapshotRepository, Test atomic replace and load with correct owner/session., Test atomic overwrite replaces the old snapshot entirely. (+4 more)
...
Cohesion: 0.16
Nodes (16): handler, GET(), getAccessToken(), jsonError(), mapProfileError(), PATCH(), ProfilePage(), authOptions (+8 more)

### Community 359 - "Phase 0 / PR 1 — Baseline reconciliation and protected frontend foundation"
Cohesion: 0.36
Nodes (8): detect_pii(), Detects if the input text contains Passport numbers, Credit card numbers (Luhn c, test_detect_pii_clean_text(), test_detect_pii_credit_card(), test_detect_pii_email(), test_detect_pii_multiple(), test_detect_pii_passport(), test_detect_pii_phone()

### Community 360 - "Phase 1 / PR 2 — Contracts, additive schema, migration, and shared types"
Cohesion: 0.14
Nodes (13): ProfileResponseContactDto, ProfileResponseDto, ProfileResponseIdentityDto, ProfileResponsePreferencesDto, ProfileResponseTravelDocumentDto, ContactSectionDto, IdentitySectionDto, PreferencesSectionDto (+5 more)
...
Cohesion: 0.60
Nodes (4): _has_exact_keys(), _is_positive_int(), Return a copied, PII-safe readiness result or ``None`` for malformed data., validate_booking_readiness_response()
...
Cohesion: 0.17
Nodes (8): FakeAsyncRedis, In-memory Async Redis mock for fast and isolated repository tests., test_nestjs_client_post_gateway_flights_search_v2(), test_nestjs_client_post_gateway_flights_search_v2_handles_400_error(), test_nestjs_client_search_flights_v2_alias(), test_snapshot_cross_user_and_session_isolation(), test_snapshot_overwrite_and_monotonic_version(), test_snapshot_ttl_calculation_and_expiry()

### Community 366 - "Phase 7 / PR 8 — Traveller booking disruption experience"
Cohesion: 0.12
Nodes (13): Test that a valid schema parses successfully., Test that schema version other than 1 is rejected., Test that unknown/forbidden fields are rejected., Test that results with forbidden fields (e.g. payment info) are rejected., Test that results list must be between 1 and 5 items., Test that result indexes must be unique and contiguous from 1., test_trusted_search_snapshot_schema_forbidden_fields(), test_trusted_search_snapshot_schema_forbidden_result_fields() (+5 more)
...
Cohesion: 0.10
Nodes (17): Request, Response, ChatStreamRequest, Request model for the chat stream endpoint., chat_stream(), _persist_response(), Request, Return an opaque telemetry identifier, never a request/session identifier. (+9 more)
...
Cohesion: 0.29
Nodes (6): project_snapshot_results(), Any, Project the trusted snapshot into the exact browser-safe result shape., Verify project_snapshot_results never returns offer IDs or provider IDs to the b, test_project_snapshot_results_excludes_identifiers(), test_project_snapshot_results_is_identifier_free()

### Community 381 - "booking-intent.e2e-spec.ts"
Cohesion: 0.29
Nodes (9): POST(), POST(), containsForbiddenKey(), FORBIDDEN_KEYS, isSafeHandoffCheckoutPayload(), noStoreJson(), proxyHandoffCheckout(), safeHandoffCheckoutOrigin() (+1 more)
...
Cohesion: 0.15
Nodes (13): ALLOWED_METADATA_KEYS, ALLOWED_STRING_VALUES, BOOLEAN_METADATA_KEYS, CHAT_HANDOFF_OBSERVABILITY_CONTRACT, ChatTelemetryEvent, createChatTelemetryEvent(), METRIC_BY_OPERATION, opaqueId() (+5 more)

### Community 385 - "Project Structure"
Cohesion: 0.12
Nodes (17): Completion Evidence, Phase 1: Contract-Freeze Checkpoint (2026-08-05), Phase 2: Checkpoint 2B (2026-08-05), Phase 2A: Redis Lifecycle Checkpoint (2026-08-05), Phase 2C: Fenced Session Lease Checkpoint (2026-08-05), Phase 2D: Trusted Snapshot Checkpoint (2026-08-05), Phase 2E: Encrypted/Additive Prisma Foundation Checkpoint (2026-08-05), Phase 2F: Inert Domain Skeletons Checkpoint (2026-08-05) (+9 more)

### Community 386 - "BookingService"
Cohesion: 0.39
Nodes (7): BookingActionCard(), SafeActionRequiredEvent, ChatWidgetInner(), consumeChatStream(), consumeSseBlock(), getSafeOfferId(), getSafeSessionId()

### Community 387 - "AncillarySelectionClient.tsx"
Cohesion: 0.14
Nodes (8): BrowserJsonResponse, FORBIDDEN_EVENT_KEYS, JsonObject, prisma, SseEvent, T093_BROWSER_TIMEOUT_MS, T093_STREAM_TIMEOUT_MS, T093_TEST_TIMEOUT_MS
...
Cohesion: 0.13
Nodes (15): Baseline and Migration Seams, Bite-Sized Delivery Phases, Compatibility and Rollout, Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Chatbot Backend Infrastructure and Booking Handoff, Observability Deliverables (+7 more)
...
Cohesion: 0.08
Nodes (8): SelectionAttestationOffer, SelectionAttestationPayload, SelectionAttestationService, envSchema, IsAttestationValidAndConsistentConstraint, AgentHandoffProbeInput, AgentStreamProbeInput, ObservedGatewayTrace
...
Cohesion: 0.14
Nodes (13): 1. Objectives, 2. File Modification & Deletion Inventory, 3. Step-by-Step Implementation & Verification Flow, Deletions, Modifications, Phase 8D Execution Plan: Approved Direct-Only Transport Cleanup, Step 1: RED Test for Direct-Only Configuration, Step 2: GREEN Code Cleanup (+5 more)
...
Cohesion: 0.18
Nodes (12): ActionRequiredEvent, BaseSSEEvent, ChatMessageEvent, DisplayInfo, HandoffEvent, TrustedSearchResult, test_accepts_valid_handoff_event(), test_rejects_handoff_event_extra_fields() (+4 more)

### Community 397 - "dependencies"
Cohesion: 0.15
Nodes (13): 10. Direct streaming is a staged transport migration, 11. Existing safety pipeline is preserved, not re-platformed, 12. Chat persistence uses application-level authenticated encryption, 1. One graph per turn, durable context restored at entry, 2. Redis is the agent control plane, not conversation storage, 3. Structured stateless router with asymmetric checkout gate, 4. Tool inventories are constructed per agent, not filtered at runtime, 5. Trusted Search Snapshot is separate from display results (+5 more)

### Community 398 - "agent-gateway.service.ts"
Cohesion: 0.21
Nodes (11): _emit_aggregate(), _p95_ms(), Maintained T098 agent benchmark coverage.  The emitted aggregate deliberately, Prove Redis Lua admits exactly one of 100 simultaneous daily-limit attempts., Return an inclusive p95 for the fixed-size benchmark sample., Print the machine-readable, PII-free aggregate required by T098., Use the existing integration convention: skip only when Redis is unavailable., Measure public stream request-to-router entry with an accepted fake quota. (+3 more)

### Community 399 - "dependencies"
Cohesion: 0.13
Nodes (5): Any, RunnableConfig, Search for available flights between two airports on a specific date. Returns th, search_flights(), ValueError

### Community 400 - "dependencies"
Cohesion: 0.12
Nodes (13): 10. Privacy rules and operator closeout, 11. Phase 11A: Production Rollout, Live Health & Operational Verification (2026-08-16), 1. System topology and decision ownership, 2. Feature flags and rollout order, 3. Health checks and dependency failures, 4.1 T098 latency and concurrency benchmark evidence (2026-08-14), 4. Dashboards and alerts, 5. Key and secret rotation (+5 more)

### Community 401 - "Code Standards"
Cohesion: 0.17
Nodes (11): 1. Objectives, 2. Target Files, 3. Step-by-Step Implementation & Verification, Documentation Reconciliation, Phase 8C Execution Plan: Privacy Verification & Full Regression, Production & Harness Modifications, Step 1: RED Test for Privacy Gaps & Privacy Corpus, Step 2: GREEN Implementation (+3 more)
...
Cohesion: 0.14
Nodes (8): AuthenticatedRequest, AgentApiKeyGuard, BookingDetailDto, BookingSummariesResponseDto, BookingSummaryDto, BookingResultDto, UserBookingsResponseDto, UserPreferencesDto

### Community 404 - "Library Docs"
Cohesion: 0.14
Nodes (15): ClaimedHandoffForIntent, HandoffFastFailReservation, LegacyIntentPassenger, ResolvedIntentPassenger, BookingIntentContactSummaryDto, BookingIntentCreationPassengerDto, BookingIntentDocumentSummaryDto, BookingIntentFlightDto (+7 more)

### Community 405 - "OutputGuardrailPipeline"
Cohesion: 0.11
Nodes (14): Request, Response, BudgetExceededException, ChatBudgetException, ChatBudgetRepository, Redis, Repository for enforcing daily and burst rate limits atomically using a single L, Atomically increment burst and daily budgets.          Returns True if admitted (+6 more)
...
Cohesion: 0.27
Nodes (6): close_redis(), init_redis(), lifespan(), Lifespan context manager that initializes NeMo Guardrails configuration,     me, setup_redis(), test_redis_lifecycle()
...
Cohesion: 0.22
Nodes (8): Feature 017 Phase 10E: Pre-Supplier Claim Verification & Consumption CAS Implementation Plan, Global Invariants & Rules, Task 1: Feature 016a Gate Verification (T070), Task 2: Token-Only Readiness & Claim DTO Validation (T083), Task 3: Pre-Supplier Claim CAS Lease, Watchdog & Recovery (T084), Task 4: Atomic Intent Creation & Consumption CAS (T084), Task 5: 100-Way Concurrency Verification Suite (T071), Task 6: Code Review, Spec Convergence & Context Synchronization
...
Cohesion: 0.22
Nodes (8): Feature 017 Phase 10F: Full Cross-Stack End-to-End Handoff Verification Plan, Global Invariants & Rules, Task 1: Pre-Execution Stack & Schema Health Check, Task 2: Fast-Check Unit & Acceptance Suites, Task 3: Next.js Production Bundle Build, Task 4: Playwright Cross-Stack E2E Test Execution, Task 5: Database & Privacy Invariant Verification, Task 6: Multi-Agent Code Review & Context Synchronization
...
Cohesion: 0.22
Nodes (8): Feature 017 Phase 11A — Production Rollout, Live Health & Operational Runbook Verification Implementation Plan, Global Constraints, Task 1: Feature Flag Governance & Rollout Matrix Tests, Task 2: Operational Runbook Drills (Redis Outage, Key Rotation, Token Expiry), Task 3: Multi-Service Health Endpoints & Subsystem Degradation, Task 4: Privacy Corpus & Structured Telemetry Audit, Task 5: Full Workspace Regression & Build Verification, Task 6: Code Review & Documentation Sync
...
Cohesion: 0.29
Nodes (6): Implementation Plan - Phase 9D: Signed Flight Search Attestation & Snapshot Isolation, NestJS Backend (`apps/api`), Proposed Changes, Python Agent (`apps/agent`), User Review Required, Verification Commands

### Community 424 - "Implementation Plan: Disruption & Flight-Change Management"
Cohesion: 0.25
Nodes (7): Feature 017 Phase 10B: Dark Create & Resolve Handoff Service & Endpoints Implementation Plan, Global Constraints, Task 1: Strict DTOs (`apps/api/src/chat-handoff/dto/`), Task 2: Service-Level Creation & Active Retry Convergence (`ChatHandoffService`), Task 3: Service-Level Resolution & Safe Allowlist Shape (`ChatHandoffService`), Task 4: Controller Endpoints & Guards (`ChatHandoffController`), Task 5: Verification & Documentation Sync
...
Cohesion: 0.06
Nodes (18): CACHE_KEYS, CACHE_TTLS, AirportsController, AirportsService, NearbyAirportsDto, SearchAirportsDto, BookingReadinessObservability, assertPersistedAuditSurfaceIsPiiSafe() (+10 more)

### Community 430 - "flights.service.ts"
Cohesion: 0.18
Nodes (4): ChatHandoffService, ChatTelemetryContext, ChatTelemetryOperation, emitChatTelemetry()
...
Cohesion: 0.29
Nodes (6): Global Constraints, T098 Correctness Remediation Implementation Plan, Task 1: Restore authoritative JWT validation, Task 2: Make fast-fail reservations route-scoped and releasable, Task 3: Restore canonical handoff/session finalization, Task 4: Verify and record T098
...
Cohesion: 0.20
Nodes (9): Feature 017 Phase 9A: Safe Booking Projection Foundation Implementation Plan, Global Constraints, Task 1: BookingAgentProjection Schema & DDL Verification, Task 2: Implement `BookingAgentProjectionService` with TDD, Task 3: Transactional Projection Population on Booking Confirmation, Failure, Completion, and Cancellation, Task 4: Projection Refresh on Supplier Sync, Disruption Reconciliation, and Duffel Webhook Events, Task 5: Existing-Booking Backfill Script & Service Integration, Task 6: Privacy Contract Verification & Comprehensive Integration Tests (+1 more)

### Community 439 - "payment.service.js"
Cohesion: 0.29
Nodes (6): Feature 017 Phase 10C: Deterministic Graph Nodes & SSE Action Emission Implementation Plan, Global Constraints, Task 1: Deterministic Handoff Client (`apps/agent/src/agent/tools/nestjs_client.py`), Task 2: Deterministic Graph Nodes & State Validation (`apps/agent/src/agent/graph/nodes.py` & `graph.py`), Task 3: Streaming SSE Action Contract & Privacy Isolation (`apps/agent/src/agent/streaming/sse.py`), Task 4: Regression Verification & Documentation Update
...
Cohesion: 0.50
Nodes (3): MOCK_MALICIOUS_PAYLOAD, MOCK_MULTI_PAYLOAD, MOCK_SINGLE_PAYLOAD
...
Cohesion: 0.33
Nodes (5): Feature 017 Phase 10D: Web Handoff Bootstrap & Clean Checkout Resolution Implementation Plan, Global Constraints, Task 1: Handoff Bootstrap & Resolution Core Logic, Task 2: Same-Origin Bootstrap Route & Server-Side Passenger Page Resolution, Task 3: Full Suite Verification, Code Review & Documentation

### Community 471 - "user-bookings.dto.ts"
Cohesion: 0.14
Nodes (13): BookingReadinessConfig, BookingReadinessConfigEnv, clampPassportAdvisoryBufferDays(), parseBookingReadinessConfig(), dateOnlyFromRaw(), iataFromRaw(), isValidDateOnly(), NormalizedOffer (+5 more)
...
Cohesion: 0.07
Nodes (25): AncillariesController, AuthenticatedRequest, AncillariesService, OwnedIntent, AncillaryCatalogService, assertCurrency(), calculateAncillaryTotals(), formatCents() (+17 more)

### Community 489 - "Global Constraints"
Cohesion: 0.25
Nodes (7): Global Constraints, Phase 8E: Approved Encrypted-Chat Plaintext Cleanup (T102) Implementation Plan, Task 1: Write Failing Privacy & Cleanup Verification Tests (TDD RED), Task 2: Refactor Legacy Readers & Writers in NestJS Backend, Task 3: Apply Migration & Update Prisma Schema, Task 4: Full Regression & Privacy Corpus Gate Verification, Task 5: Document Completion Evidence & Update Feature Specifications
...
### Community 491 - "readPaymentReservation"
Cohesion: 0.20
Nodes (3): AgentHealthResult, AgentHealthService, HealthController

### Community 492 - "AncillarySelectionClient.tsx"
Cohesion: 0.12
Nodes (12): BaggageChoice, priceKey(), Props, SeatChoice, SeatMap(), SeatTier, ServiceView, tierClasses (+4 more)

### Community 493 - ".create"
Cohesion: 0.30
Nodes (4): ChatHandoffController, ChatHandoffResponseDto, CreateChatHandoffDto, ResolveChatHandoffDto

### Community 494 - "passport-expiry-backfill.controller.ts"
Cohesion: 0.30
Nodes (5): BackfillOptionsDto, PassportExpiryBackfillController, BackfillOptions, BackfillResult, PassportExpiryBackfillService

### Community 495 - "page.tsx"
Cohesion: 0.20
Nodes (10): MOCK_BOOKINGS, MockBookingDetailResponse, BookingDetailResponse, Props, BookingConfirmationBanner(), BookingConfirmationBannerProps, FlightSegmentSnapshot, PassengerSnapshot (+2 more)

### Community 496 - "booking-intent.types.ts"
Cohesion: 0.25
Nodes (7): Global Constraints, Phase 9B: Exact Booking Projection Gateway Read Boundaries Implementation Plan, Task 1: Strict DTO Definitions and Shared Types (T058), Task 2: Service Unit Tests with Query Spies and Privacy Bounds (T054), Task 3: Service Implementation with Projection Exclusivity (T060), Task 4: Controller Endpoints and E2E Tests (T055, T061), Task 5: Code Review, Verification and Context Synchronization
...
### Community 502 - "test_phase8c_privacy.py"
Cohesion: 0.22
Nodes (8): Verify that SSE error payloads contain standard error codes and scrubbed message, Verify that any stream response data conforms to strict boundary safety and excl, Verify that pii_scrubber detects and scrubs email, phone, passport, and card., Verify _SAFE_LLM_FIELDS does not contain local offer IDs, Duffel offer IDs, or d, test_pii_scrubber_redacts_seeded_corpus(), test_safe_llm_fields_excludes_identifiers(), test_sse_error_payloads_contain_zero_pii_or_tokens(), test_sse_event_serialization_excludes_forbidden_corpus()

### Community 503 - "flights.controller.ts"
Cohesion: 0.39
Nodes (5): FlightSearchRequestDto, FlightSearchResponseDto, AuthenticatedRequest, FlightsController, FlightsService
...
### Community 505 - "disruption-phase3.e2e-spec.js"
Cohesion: 0.22
Nodes (8): app_module_1, client_1, common_1, crypto, duffel_service_1, prisma_service_1, supplier_sync_service_1, testing_1

### Community 506 - "BookingStatusBadge.tsx"
Cohesion: 0.15
Nodes (15): BookingDetail(), BookingDetailProps, currencyFormatter(), BookingProcessingState(), DisruptionAlert(), DisruptionAlertProps, REASON_LABELS, RESOLVED_REASON_LABELS (+7 more)

### Community 507 - "User Scenarios & Testing *(mandatory)*"
Cohesion: 0.25
...
### Community 508 - "Feature 017 Phase 9C: Python Read Tools & Privacy-Minimized Formatting Plan"
Cohesion: 0.40
Nodes (4): Architecture & Data Flow, Feature 017 Phase 9C: Python Read Tools & Privacy-Minimized Formatting Plan, Goal, Implementation Steps (TDD)

### Community 509 - "booking-intent.service.spec.ts"
Cohesion: 0.29
Nodes (6): CanonicalPrismaMock, MockAuditService, MockDuffelService, MockEncryptionService, MockPrismaService, TestableService

### Community 510 - "layout.tsx"
Cohesion: 0.33
Nodes (4): metadata, ChatWidget(), Props, Providers()

### Community 511 - "CheckoutHandoffCard.tsx"
Cohesion: 0.38
Nodes (4): CheckoutHandoffCard(), CheckoutHandoffCardProps, appendHandoffCredential(), HandoffEvent

### Community 512 - "BookingStatusBadge.tsx"
Cohesion: 0.33
Nodes (5): BookingStatus, BookingStatusBadge(), BookingStatusBadgeProps, statusLabels, statusStyles

### Community 513 - "ItineraryChangeSummary.tsx"
Cohesion: 0.33
Nodes (4): ItineraryChangeSummary(), ItineraryChangeSummaryProps, PresentationSummary, SliceSummary

### Community 514 - "safeReturnTarget.ts"
Cohesion: 0.60
Nodes (4): ALLOWED_RETURN_PREFIXES, getSafeReturnTarget(), isAllowedPath(), safeSearch()

### Community 516 - "Phase 4 / PR 5 — Signed webhook receiver, durable inbox, and processor"
Cohesion: 0.50
Nodes (4): Exit criteria, Phase 4 / PR 5 — Signed webhook receiver, durable inbox, and processor, Tests, Work

### Community 517 - "Phase 6 / PR 7 — Traveller APIs, local read model, and cancellation integration"
Cohesion: 0.50
Nodes (4): Exit criteria, Phase 6 / PR 7 — Traveller APIs, local read model, and cancellation integration, Tests, Work

### Community 518 - "Phase 7 / PR 8 — Traveller booking disruption experience"
Cohesion: 0.50
Nodes (4): Exit criteria, Phase 7 / PR 8 — Traveller booking disruption experience, Tests, Work

### Community 519 - "Project Structure"
Cohesion: 0.67
...
Cohesion: 0.15
Nodes (22): AncillarySelectionClient(), money(), AncillaryCalculatedTotals, AncillaryReconciliationIssue, AncillarySelectionAction, AncillarySelectionHydration, ancillarySelectionReducer(), AncillarySelectionState (+14 more)
...
Cohesion: 0.18
Nodes (12): BookingsPageProps, BookingCard(), BookingCardBooking, BookingCardProps, formatCurrency(), formatDate(), BookingListItem, BookingsList() (+4 more)
...
Cohesion: 0.22
Nodes (14): get_checkout_tools(), get_general_tools(), get_tool_by_name(), get_tools(), get_travel_tools(), Get a list of all registered tool instances., Retrieve a registered tool instance by its name., Check if a tool requires confirmation before execution.     In the new topology (+6 more)
...
Cohesion: 0.11
Nodes (15): format_messages(), get_chat_model(), Any, BaseMessage, Initialize and return the LangChain ChatOpenAI instance configured with Mimo end, Format chat session history, summary, and current user message into a list of La, general_agent_node(), RunnableConfig (+7 more)
...
Cohesion: 0.20
Nodes (11): route_after_router(), route_after_tools(), route_after_validate(), router_node(), should_continue(), Determine the next step after tools are executed., Conditional router to determine next step in the graph., route_after_tools() (+3 more)
...
Cohesion: 0.24
Nodes (9): ALLOWED_METADATA_KEY_SET, BookingReadinessObservabilityContext, BookingReadinessObservabilityEvent, safeMetadata(), sanitizeIdentifier(), ALLOWED_METADATA_KEYS, BookingReadinessMetric, BookingReadinessOperation (+1 more)
...
Cohesion: 0.27
Nodes (11): fetchBrowserProfile(), requestBrowserProfile(), updateBrowserProfile(), ErrorBody, getProfileRequestError(), isErrorBody(), ProfileContactUpdate, ProfileDocumentUpdate (+3 more)
...
Cohesion: 0.16
Nodes (16): AncillariesPage(), Props, PaymentPage(), Props, Props, ReviewPage(), SearchPage(), LogoutButton() (+8 more)
...
## Knowledge Gaps
- **2916 isolated node(s):** `root`, `parser`, `plugins`, `extends`, `node` (+2911 more)
...
- **Why does `passenger()` connect `utils.ts` to `plan.md`, `graph.py`, `Delivery phases and pull requests`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `isHandoffCheckoutContext()` connect `plan.md` to `utils.ts`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PrismaService` connect `scripts` to `Phase 4 / PR 5 — Signed webhook receiver, durable inbox, and processor`, `prisma.service.ts`, `.createLog`, `NestJSClient`, `detect_pii`, `Library Docs`, `scripts`, `ChunkBuffer`, `AuditService`, `app.module.ts`, `layout.tsx`, `BookingIntentService`, `booking.service.js`, `flights.service.ts`, `utils.ts`, `PaymentMethodService`, `auth.spec.ts`, `paths`, `payment-refund.e2e-spec.ts`, `user-bookings.dto.ts`, `intent-response.dto.ts`, `AncillariesService`, `Phase 1 / PR 2 — Contracts, additive schema, migration, and shared types`, `readPaymentReservation`, `passport-expiry-backfill.controller.ts`, `test_pipeline_parallelism.py`, `seed.ts`, `devDependencies`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Are the 45 inferred relationships involving `NestJSClient` (e.g. with `MemoryManager` and `chat_stream()`) actually correct?**
  _`NestJSClient` has 45 INFERRED edges - model-reasoned connections that need verification._
