...
## Corpus Check
- 736 files · ~530,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6094 nodes · 9090 edges · 565 communities (410 shown, 155 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 364 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f4221abb`
...
- [[_COMMUNITY_create_handoff_token|create_handoff_token]]
- [[_COMMUNITY_dependencies|dependencies]]
...
- [[_COMMUNITY_booking-handoff.controller.ts|booking-handoff.controller.ts]]
- [[_COMMUNITY_Decisions Made|Decisions Made]]
...
- [[_COMMUNITY_test_streaming_agent.py|test_streaming_agent.py]]
- [[_COMMUNITY_intent-response.dto.ts|intent-response.dto.ts]]
- [[_COMMUNITY_AncillarySelectionClient.tsx|AncillarySelectionClient.tsx]]
- [[_COMMUNITY_Global Constraints|Global Constraints]]
...
- [[_COMMUNITY_handoff-fast-fail.guard.ts|handoff-fast-fail.guard.ts]]
...
- [[_COMMUNITY_profile-response.dto.ts|profile-response.dto.ts]]
- [[_COMMUNITY_health.e2e-spec.js|health.e2e-spec.js]]
- [[_COMMUNITY_Phase 2  PR 3 — Pure itinerary normalization, matching, diff, and classification|Phase 2 / PR 3 — Pure itinerary normalization, matching, diff, and classification]]
- [[_COMMUNITY_Phase 5  PR 6 — Budget-aware reconciliation and correct completion lifecycle|Phase 5 / PR 6 — Budget-aware reconciliation and correct completion lifecycle]]
...
10. `ChatHandoffService` - 34 edges
...
## Communities (565 total, 155 thin omitted)
...
Cohesion: 0.04
Nodes (31): SafeBookingProjectionData, AppModule, HttpExceptionFilter, DuffelCleanupService, DuffelConfirmedCancellation, DuffelRecoveredOrder, DuffelOfferRequest, bootstrap() (+23 more)
...
Cohesion: 0.19
Nodes (8): AuthenticatedRequest, BookingDetailDto, AgentBookingReadinessPassengerDto, AgentBookingReadinessRequestDto, AgentBookingReadinessResponseDto, BookingSummaryDto, FlightResultDto, BookingResultDto
...
Cohesion: 0.05
Nodes (29): AuthController, AuthenticatedRequest, AuthModule, AuthService, LoginDto, RegisterDto, LockoutService, ActiveUser (+21 more)
...
Cohesion: 0.15
Nodes (10): Request, Response, ChatStreamRequest, Request model for the chat stream endpoint., chat_stream(), Request, Handle POST /chat/stream requests, performing validation, checking guardrails,, decode_and_verify_jwt() (+2 more)
...
Cohesion: 0.11
Nodes (11): BookingReadinessPassengerSourceConstraint, BookingReadinessPassengerSourceDto, BookingReadinessResponseDto, HandoffSourceConstraint, hasOnlyKeys(), HasValidHandoffSource(), INLINE_SOURCE_KEYS, isRecord() (+3 more)
...
Cohesion: 0.10
Nodes (13): CanonicalPassengerMetadataConstraint, CanonicalPassengerShapeConstraint, CreateIntentDto, CreateIntentPassengerDto, InlinePassengerSourceDto, LEGACY_PASSENGER_FIELDS, LEGACY_REQUIRED_PASSENGER_FIELDS, missingLegacyPassengerFields() (+5 more)

### Community 250 - "seed.ts"
Cohesion: 0.16
Nodes (8): ProfileResponseDto, ContactSectionDto, IdentitySectionDto, PreferencesSectionDto, TravelDocumentSectionDto, UpdateProfileDto, AuthenticatedRequest, ProfileController
...
Cohesion: 0.05
Nodes (17): BookingAgentProjectionService, BookingService, BookingWithRelations, enrichRedactedDuffelOrder(), parseDuffelCancellationQuoteId(), serializeDuffelCancellationQuoteId(), AuthenticatedRequest, DisruptionController (+9 more)
...
Cohesion: 0.16
Nodes (16): AuthenticatedSession, getAuthenticatedSession(), hasValidSameOriginHeaders(), POST(), isSameOrigin(), BootstrapFetcher, createHandoffRedirectResponse(), HandoffBootstrapResult (+8 more)
...
Cohesion: 0.30
Nodes (16): get_auth_headers(), mock_nestjs_client(), MockStreamingLLM, parse_sse(), test_sse_action_handoff_disabled_flag(), test_sse_action_handoff_disconnect_retry(), test_sse_action_handoff_index_out_of_bounds_no_token(), test_sse_action_handoff_ordering_and_schema() (+8 more)
...
Cohesion: 0.06
Nodes (11): RefundResolutionAction, PaymentCronService, enrichRedactedDuffelOrder(), redactDuffelOrder(), ALLOWED_TRANSITIONS, canTransition(), enforceTransition(), getPreDisputeStatus() (+3 more)
...
Cohesion: 0.13
Nodes (3): DuffelEventProcessor, DuffelProcessorHealthService, HealthController
...
Cohesion: 0.18
Nodes (5): Roles(), RolesGuard, AdminRefundController, refundResolutionActions, ResolveRefundDto
...
Cohesion: 0.17
Nodes (20): AgentGatewayModule, AncillariesModule, envSchema, AuditModule, BookingModule, BookingIntentModule, CacheModule, ChatModule (+12 more)

### Community 327 - "paths"
Cohesion: 0.06
Nodes (32): StripeService, LeasedSnapshot, ValidateAncillaryPaymentInput, ValidatedAncillaryPayment, ValidationIntent, ConfirmPaymentDto, CreatePaymentDto, PaymentResponseDto (+24 more)
...
Cohesion: 0.08
Nodes (31): classOptions, countryOptions, documentOptions, genderOptions, getMaskedPassport(), phoneCountryOptions, ProfileDraft, ProfileSection (+23 more)

### Community 349 - "API Contracts: Cancellation & Refund Recovery"
Cohesion: 0.09
Nodes (27): TrustedSearchSnapshot, Redis, Atomically replaces the old snapshot and sets the TTL based on expiresAt., Loads the snapshot and verifies owner/session match., Atomically delete the snapshot., TrustedSnapshotRepository, test_snapshot_cross_user_and_session_isolation(), test_snapshot_ttl_calculation_and_expiry() (+19 more)
...
Cohesion: 0.16
Nodes (17): handler, GET(), getAccessToken(), jsonError(), mapProfileError(), PATCH(), ProfilePage(), authOptions (+9 more)

### Community 359 - "Phase 0 / PR 1 — Baseline reconciliation and protected frontend foundation"
Cohesion: 0.20
Nodes (12): detect_pii(), Detects if the input text contains Passport numbers, Credit card numbers (Luhn c, Verify that pii_scrubber detects and scrubs email, phone, passport, and card., Verify _SAFE_LLM_FIELDS does not contain local offer IDs, Duffel offer IDs, or d, test_pii_scrubber_redacts_seeded_corpus(), test_safe_llm_fields_excludes_identifiers(), test_detect_pii_clean_text(), test_detect_pii_credit_card() (+4 more)

### Community 360 - "Phase 1 / PR 2 — Contracts, additive schema, migration, and shared types"
Cohesion: 0.18
Nodes (6): FakeAsyncRedis, In-memory Async Redis mock for fast and isolated repository tests., test_nestjs_client_post_gateway_flights_search_v2(), test_nestjs_client_post_gateway_flights_search_v2_handles_400_error(), test_nestjs_client_search_flights_v2_alias(), test_snapshot_overwrite_and_monotonic_version()
...
Cohesion: 0.14
Nodes (14): BookingReadinessConfig, BookingReadinessConfigEnv, clampPassportAdvisoryBufferDays(), parseBookingReadinessConfig(), dateOnlyFromRaw(), iataFromRaw(), isValidDateOnly(), NormalizedOffer (+6 more)
...
Cohesion: 0.21
Nodes (11): BookingActionCard(), SafeActionRequiredEvent, ChatWidgetInner(), consumeChatStream(), consumeSseBlock(), getSafeOfferId(), getSafeSessionId(), CheckoutHandoffCard() (+3 more)
...
Cohesion: 0.15
Nodes (8): assertCanonicalCreate(), AuthenticatedRequest, BookingIntentController, BookingIntentLegacyController, requestContext(), setSafeHeaders(), BookingReadinessRequestDto, GetBookingIntentResponseDto
...
Cohesion: 0.14
Nodes (9): capitalizeCabinClass(), cleanIsoTime(), formatDuffelBaggageAllowance(), parseISODurationToMinutes(), AttestedFlightSearchDto, AttestedFlightSearchResponseDto, AttestedFlightSearchResultDto, FlightSearchResponseDto (+1 more)
...
Cohesion: 0.05
Nodes (23): CABIN_KEYWORDS, PASSENGER_KEYWORDS, SelectionAttestationOffer, SelectionAttestationPayload, SelectionAttestationService, OwnedIntent, AuditService, BookingReadinessObservability (+15 more)
...
Cohesion: 0.14
Nodes (8): AgentApiKeyGuard, AuthenticatedRequest, ChatHandoffController, ChatHandoffSafeResolveResponse, IsAttestationValidAndConsistentConstraint, ResolveChatHandoffDto, createHandoff(), postJson()
...
Cohesion: 0.17
Nodes (9): project_snapshot_results(), Any, RunnableConfig, Project the trusted snapshot into the exact browser-safe result shape., Search for available flights between two airports on a specific date. Returns th, search_flights(), Verify project_snapshot_results never returns offer IDs or provider IDs to the b, test_project_snapshot_results_excludes_identifiers() (+1 more)
...
Cohesion: 0.21
Nodes (11): ALLOWED_METADATA_KEYS, ALLOWED_STRING_VALUES, BOOLEAN_METADATA_KEYS, CHAT_HANDOFF_OBSERVABILITY_CONTRACT, ChatTelemetryEvent, ChatTelemetryOperation, createChatTelemetryEvent(), emitChatTelemetry() (+3 more)
...
Cohesion: 0.21
Nodes (13): AttestationOffer, AttestationPayload, ClaimedHandoffRow, firstFlightSegment(), handoffPassengers(), InFlightReservation, isJsonRecord(), isoDateValue() (+5 more)
...
### Community 459 - "create_handoff_token"
Cohesion: 0.32
...
### Community 469 - "booking-handoff.controller.ts"
Cohesion: 0.36
Nodes (3): AuthenticatedRequest, BookingHandoffController, ResolveChatHandoffBodyDto

### Community 471 - "disruption-phase3.e2e-spec.js"
Cohesion: 0.22
...
### Community 490 - "test_streaming_agent.py"
Cohesion: 0.50
...
### Community 491 - "intent-response.dto.ts"
Cohesion: 0.24
Nodes (9): BookingIntentContactSummaryDto, BookingIntentCreationPassengerDto, BookingIntentDocumentSummaryDto, BookingIntentFlightDto, BookingIntentPassengerDetailDto, BookingIntentPassengerSummaryDto, BookingIntentPrefillPassengerDto, BookingIntentPrefillResponseDto (+1 more)
...
### Community 493 - "Global Constraints"
Cohesion: 0.25
...
### Community 494 - "rate-limit.e2e-spec.js"
Cohesion: 0.29
...
### Community 497 - "paths"
Cohesion: 0.09
Nodes (21): ClaimedHandoffForIntent, HandoffFastFailReservation, LegacyIntentPassenger, ResolvedIntentPassenger, CanonicalPrismaMock, MockAuditService, MockDuffelService, MockEncryptionService (+13 more)
...
Cohesion: 0.33
Nodes (4): AuthenticatedRequest, CommitBaggageDto, CommitSeatDto, JwtAuthGuard

### Community 503 - "handoff-fast-fail.guard.ts"
Cohesion: 0.29
...
Cohesion: 0.06
Nodes (38): BookingDetail(), BookingDetailProps, currencyFormatter(), BookingProcessingState(), DisruptionAlert(), DisruptionAlertProps, REASON_LABELS, RESOLVED_REASON_LABELS (+30 more)

### Community 507 - "Global Constraints"
Cohesion: 0.29
...
### Community 510 - "profile-response.dto.ts"
Cohesion: 0.40
Nodes (4): ProfileResponseContactDto, ProfileResponseIdentityDto, ProfileResponsePreferencesDto, ProfileResponseTravelDocumentDto

### Community 511 - "health.e2e-spec.js"
Cohesion: 0.40
Nodes (3): test_first_chunk_unsafe(), test_mid_stream_chunk_unsafe(), test_nestjs_persistence_fails()

### Community 512 - "Phase 2 / PR 3 — Pure itinerary normalization, matching, diff, and classification"
Cohesion: 0.40
Nodes (3): test_sse_output_guardrail_disabled(), test_sse_output_guardrail_safe(), test_sse_output_guardrail_unsafe_blocking()

### Community 513 - "Phase 5 / PR 6 — Budget-aware reconciliation and correct completion lifecycle"
Cohesion: 0.40
...
Cohesion: 0.13
Nodes (16): BookingsPageProps, BookingCard(), BookingCardBooking, BookingCardProps, formatCurrency(), formatDate(), BookingListItem, BookingsList() (+8 more)
...
Cohesion: 0.08
Nodes (29): AncillariesPage(), Props, PaymentPage(), Props, Props, ReviewPage(), PassengerPageFlightDetail, PassengersPage() (+21 more)
...
## Knowledge Gaps
- **2890 isolated node(s):** `root`, `parser`, `plugins`, `extends`, `node` (+2885 more)
...
- **Why does `isHandoffCheckoutContext()` connect `plan.md` to `Delivery phases and pull requests`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `PrismaService` connect `app.module.ts` to `Payment System — Grilling Decisions`, `BookingService`, `Library Docs`, `scripts`, `AuditService`, `Implementation Phases`, `BookingIntentService`, `PaymentMethodService`, `payment-refund.e2e-spec.ts`, `paths`, `playwright.config.ts`, `API Contracts: Stripe Payment System`, `agent`, `User Scenarios & Testing *(mandatory)*`, `AncillariesService`, `CheckoutHandoffCard.tsx`, `paths`, `test_pipeline_parallelism.py`, `seed.ts`, `flights.controller.ts`, `scripts`?**
