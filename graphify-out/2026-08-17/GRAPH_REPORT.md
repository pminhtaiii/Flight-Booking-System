...
## Corpus Check
- 749 files · ~547,700 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6187 nodes · 9458 edges · 567 communities (413 shown, 154 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 413 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48a9026f`
...
- [[_COMMUNITY_ancillary-pricing.ts|ancillary-pricing.ts]]
- [[_COMMUNITY_._astream|._astream]]
- [[_COMMUNITY_intent-response.dto.ts|intent-response.dto.ts]]
- [[_COMMUNITY_PaymentController|PaymentController]]
...
- [[_COMMUNITY_chatStream.ts|chatStream.ts]]
- [[_COMMUNITY_test_graph.py|test_graph.py]]
- [[_COMMUNITY_paths|paths]]
- [[_COMMUNITY_Phase 0  PR 1 — Baseline reconciliation and protected frontend foundation|Phase 0 / PR 1 — Baseline reconciliation and protected frontend foundation]]
- [[_COMMUNITY_Phase 3  PR 4 — Supplier synchronization transaction and concurrency|Phase 3 / PR 4 — Supplier synchronization transaction and concurrency]]
- [[_COMMUNITY_._astream|._astream]]
- [[_COMMUNITY_AgentHealthService|AgentHealthService]]
...
- [[_COMMUNITY_data-drift-sentinel.service.ts|data-drift-sentinel.service.ts]]
- [[_COMMUNITY_BookingStatusBadge.tsx|BookingStatusBadge.tsx]]
- [[_COMMUNITY_ItineraryChangeSummary.tsx|ItineraryChangeSummary.tsx]]
- [[_COMMUNITY_booking-readiness.config.ts|booking-readiness.config.ts]]
...
## Communities (567 total, 154 thin omitted)
...
Cohesion: 0.08
Nodes (26): MemoryManager, Any, Manager responsible for counting tokens, tracking budget, and triggering      a, Count tokens in text using tiktoken base encoding, falling back to approximation, Calculate total tokens of messages that slid out of window plus the existing sum, Check if the token count of older messages (messages that have slid out of the w, Invoke LLM to generate an updated summary incorporating new slide-out messages a, test_check_and_summarize_exceeds_budget() (+18 more)

### Community 19 - "detect_pii"
Cohesion: 0.05
Nodes (30): AgentApiKeyGuard, envSchema, HandoffFastFailGuard, HandoffRequest, RequestFixture, AuthenticatedRequest, BookingHandoffController, AuthenticatedRequest (+22 more)
...
Cohesion: 0.05
Nodes (24): AppModule, HttpExceptionFilter, bootstrap(), CacheServiceWithInternal, CircularMetadata, SanitizedUserMetadata, SanitizedVariantsMetadata, chatEncryptionKey (+16 more)
...
Cohesion: 0.08
Nodes (39): ChatTelemetry, dashboard_alert_contract(), _new_opaque_id(), Any, Allowlisted, value-free telemetry for the chat rollout.  This module deliberat, Return the maintained dashboard/alert contract for agent telemetry.      This, Raised when an event would exceed the chat telemetry contract., Map runtime tool names to a bounded, non-sensitive telemetry label. (+31 more)
...
### Community 79 - "agent"
Cohesion: 0.17
Nodes (6): assertCanonicalCreate(), BookingIntentController, BookingIntentLegacyController, requestContext(), setSafeHeaders(), GetBookingIntentResponseDto
...
Cohesion: 0.11
Nodes (14): Request, Response, ChatStreamRequest, Request model for the chat stream endpoint., chat_stream(), Request, Handle POST /chat/stream requests, performing validation, checking guardrails,, decode_and_verify_jwt() (+6 more)

### Community 115 - "Implementation Plan: LLM Output Guardrails"
Cohesion: 0.13
Nodes (4): enrichRedactedDuffelOrder(), PaymentCronService, enrichRedactedDuffelOrder(), redactDuffelOrder()
...
Cohesion: 0.09
Nodes (18): Roles(), RolesGuard, LeasedSnapshot, ValidateAncillaryPaymentInput, ValidatedAncillaryPayment, ValidationIntent, ConfirmPaymentDto, CreatePaymentDto (+10 more)
...
Cohesion: 0.24
Nodes (5): AuthenticatedRequest, AttestedFlightSearchDto, AttestedFlightSearchResponseDto, AttestedFlightSearchResultDto, FlightSearchQueryDto
...
Cohesion: 0.16
Nodes (5): AuthenticatedRequest, DisruptionController, TravellerDisruptionController, DisruptionService, SyncResult

### Community 255 - "devDependencies"
Cohesion: 0.17
Nodes (6): ALLOWED_TRANSITIONS, canTransition(), enforceTransition(), getPreDisputeStatus(), resolveDisputeStatus(), PaymentWebhookService
...
Cohesion: 0.09
Nodes (12): AuthenticatedRequest, BookingController, BookingService, parseDuffelCancellationQuoteId(), serializeDuffelCancellationQuoteId(), BookingListQueryDto, BookingTab, BookingDetailResponseDto (+4 more)
...
Cohesion: 0.12
Nodes (3): BookingIntentCron, BookingIntentService, BookingIntentPrefillResponseDto
...
Cohesion: 0.10
Nodes (6): AdminRefundController, RefundPaymentDto, RefundResolutionAction, refundResolutionActions, ResolveRefundDto, PaymentRefundService
...
Cohesion: 0.12
Nodes (4): AgentGatewayController, AgentGatewayService, BookingSummariesResponseDto, UserBookingsResponseDto
...
Cohesion: 0.22
Nodes (17): AgentGatewayModule, AirportsModule, AncillariesModule, AuditModule, BookingModule, BookingIntentModule, CacheModule, ChatModule (+9 more)

### Community 327 - "paths"
Cohesion: 0.12
Nodes (15): OwnedIntent, AuditService, StripeService, dto, validated, ancillaryDto, validatedAncillary, boundSelection (+7 more)
...
Cohesion: 0.06
Nodes (33): TrustedSearchSnapshot, Redis, Atomically replaces the old snapshot and sets the TTL based on expiresAt., Loads the snapshot and verifies owner/session match., Atomically delete the snapshot., TrustedSnapshotRepository, FakeAsyncRedis, In-memory Async Redis mock for fast and isolated repository tests. (+25 more)
...
Cohesion: 0.20
Nodes (8): ActiveUser, JwtPayload, ValidatedUser, BenchmarkSummary, createHandoff(), httpAgent, mintClaimToken(), postJson()
...
Cohesion: 0.05
Nodes (26): BookingWithRelations, BookingReadinessObservability, CacheService, ReconciliationResult, ReconciliationService, DbSegment, PrismaError, SupplierSyncService (+18 more)
...
Cohesion: 0.21
Nodes (14): fetchBrowserProfile(), requestBrowserProfile(), updateBrowserProfile(), ErrorBody, getProfileRequestError(), isErrorBody(), ProfileContactUpdate, ProfileDocumentUpdate (+6 more)

### Community 366 - "Phase 7 / PR 8 — Traveller booking disruption experience"
Cohesion: 0.16
Nodes (5): BookingAgentProjectionService, SafeBookingProjectionData, chatEncryptionKey, encryptionKey, SENSITIVE_PRIVACY_CORPUS
...
Cohesion: 0.06
Nodes (33): SelectionAttestationOffer, SelectionAttestationPayload, SelectionAttestationService, ClaimedHandoffForIntent, HandoffFastFailReservation, LegacyIntentPassenger, ResolvedIntentPassenger, ALLOWED_METADATA_KEYS (+25 more)
...
Cohesion: 0.19
Nodes (3): AncillariesService, AncillaryCatalogService, DuffelSeatMap

### Community 396 - "page.tsx"
Cohesion: 0.15
Nodes (16): ActionRequiredEvent, BaseSSEEvent, ChatMessageEvent, DisplayInfo, HandoffEvent, TrustedSearchResult, test_accepts_valid_handoff_event(), test_rejects_handoff_event_extra_fields() (+8 more)
...
Cohesion: 0.15
Nodes (9): CABIN_KEYWORDS, PASSENGER_KEYWORDS, BookingDetailDto, BookingSummaryDto, FlightResultDto, BookingResultDto, UserPreferencesDto, CryptoKeyUnavailableError (+1 more)
...
Cohesion: 0.11
Nodes (18): _persist_response(), Resolves the original user message from body or graph state., Persists the user and agent messages as a batch.     Revalidates active fence i, _resolve_user_message(), make_token(), Chaos Simulation: RateLimitMiddleware fails closed with 503 CHAT_CONTROL_PLANE_U, Chaos Simulation: If Redis drops mid-stream during background session lock refre, Chaos Simulation: When client abruptly disconnects during streaming (asyncio.Can (+10 more)
...
Cohesion: 0.14
Nodes (12): project_snapshot_results(), Any, Project the trusted snapshot into the exact browser-safe result shape., Verify that SSE error payloads contain standard error codes and scrubbed message, Verify that pii_scrubber detects and scrubs email, phone, passport, and card., Verify _SAFE_LLM_FIELDS does not contain local offer IDs, Duffel offer IDs, or d, Verify project_snapshot_results never returns offer IDs or provider IDs to the b, test_pii_scrubber_redacts_seeded_corpus() (+4 more)
...
Cohesion: 0.19
Nodes (7): AncillariesController, AuthenticatedRequest, CommitAncillarySelectionDto, CommitBaggageDto, CommitSeatDto, JwtAuthGuard, AuthenticatedRequest
...
Cohesion: 0.14
Nodes (12): CanonicalPrismaMock, MockAuditService, MockDuffelService, MockEncryptionService, MockPrismaService, TestableService, EncryptionContext, InlinePassengerSource (+4 more)
...
Cohesion: 0.07
Nodes (16): CACHE_KEYS, CACHE_TTLS, AirportsController, AirportsService, NearbyAirportsDto, SearchAirportsDto, assertPersistedAuditSurfaceIsPiiSafe(), AuthUser (+8 more)
...
### Community 469 - "agent-gateway-polish.e2e-spec.js"
Cohesion: 0.18
...
### Community 489 - "ancillary-pricing.ts"
Cohesion: 0.33
...
### Community 493 - "disruption-phase3.e2e-spec.js"
Cohesion: 0.22
...
### Community 503 - "CheckoutHandoffCard.tsx"
Cohesion: 0.38
...
### Community 505 - ".checkBookingReadiness"
Cohesion: 0.53
Nodes (3): AgentBookingReadinessPassengerDto, AgentBookingReadinessRequestDto, AgentBookingReadinessResponseDto

### Community 506 - "data-drift-sentinel.service.ts"
Cohesion: 0.33
Nodes (5): BookingProjectionSyncResult, ConsumedHandoffIntegrityResult, DanglingClaimHealingResult, ELIGIBLE_PROJECTION_STATUSES, FullDriftSentinelAuditSummary

### Community 507 - "BookingStatusBadge.tsx"
Cohesion: 0.33
Nodes (5): BookingStatus, BookingStatusBadge(), BookingStatusBadgeProps, statusLabels, statusStyles

### Community 508 - "ItineraryChangeSummary.tsx"
Cohesion: 0.33
Nodes (4): ItineraryChangeSummary(), ItineraryChangeSummaryProps, PresentationSummary, SliceSummary

### Community 509 - "booking-readiness.config.ts"
Cohesion: 0.50
Nodes (4): BookingReadinessConfig, BookingReadinessConfigEnv, clampPassportAdvisoryBufferDays(), parseBookingReadinessConfig()

### Community 510 - "17. Phase 11D: Post-Rollout Decommissioning, Direct-Only Architecture Lockdown & Final Cryptographic Sign-Off (2026-08-17)"
Cohesion: 0.40
...
### Community 511 - "18. Phase 11E: Continuous Reliability, Automated Drift Detection & Key Rotation Automation (2026-08-17)"
Cohesion: 0.50
...
Cohesion: 0.10
Nodes (25): AncillariesPage(), Props, PaymentPage(), Props, Props, ReviewPage(), SearchPage(), LogoutButton() (+17 more)
...
## Knowledge Gaps
- **2874 isolated node(s):** `root`, `parser`, `plugins`, `extends`, `node` (+2869 more)
