# Graph Report - Booking Systems  (2026-08-18)

## Corpus Check
- 760 files · ~567,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6297 nodes · 9699 edges · 570 communities (411 shown, 159 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 413 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `094c8c71`
...
- [[_COMMUNITY_Decisions Made|Decisions Made]]
- [[_COMMUNITY_CreateIntentDto|CreateIntentDto]]
...
- [[_COMMUNITY_test_hard_stop.py|test_hard_stop.py]]
- [[_COMMUNITY_MemoryQueryDto|MemoryQueryDto]]
- [[_COMMUNITY_17. Phase 11D Post-Rollout Decommissioning, Direct-Only Architecture Lockdown & Final Cryptographic Sign-Off (2026-08-17)|17. Phase 11D: Post-Rollout Decommissioning, Direct-Only Architecture Lockdown & Final Cryptographic Sign-Off (2026-08-17)]]
...
- [[_COMMUNITY_UserPreferencesDto|UserPreferencesDto]]
- [[_COMMUNITY_index.ts|index.ts]]
- [[_COMMUNITY_Phase 0  PR 1 — Baseline reconciliation and protected frontend foundation|Phase 0 / PR 1 — Baseline reconciliation and protected frontend foundation]]
- [[_COMMUNITY_Phase 3  PR 4 — Supplier synchronization transaction and concurrency|Phase 3 / PR 4 — Supplier synchronization transaction and concurrency]]
- [[_COMMUNITY_._astream|._astream]]
- [[_COMMUNITY_profile.controller.ts|profile.controller.ts]]
- [[_COMMUNITY_project_snapshot_results|project_snapshot_results]]
...
- [[_COMMUNITY_booking-intent.service.spec.ts|booking-intent.service.spec.ts]]
- [[_COMMUNITY_PassengerSourceResolverService|PassengerSourceResolverService]]
- [[_COMMUNITY_User Scenarios & Testing (mandatory)|User Scenarios & Testing *(mandatory)*]]
- [[_COMMUNITY_AdminRefundController|AdminRefundController]]
- [[_COMMUNITY_ItineraryChangeSummary.tsx|ItineraryChangeSummary.tsx]]
- [[_COMMUNITY_user-bookings.dto.ts|user-bookings.dto.ts]]
- [[_COMMUNITY_.getSeatMapsAndServices|.getSeatMapsAndServices]]
- [[_COMMUNITY_profile-response.dto.ts|profile-response.dto.ts]]
- [[_COMMUNITY_4. Dashboards and Telemetry Metrics|4. Dashboards and Telemetry Metrics]]
- [[_COMMUNITY_6. Incident Response and Playbooks|6. Incident Response and Playbooks]]
- [[_COMMUNITY_8. Cryptographic and Negative PII Security Invariants|8. Cryptographic and Negative PII Security Invariants]]
- [[_COMMUNITY_18. Phase 11E Continuous Reliability, Automated Drift Detection & Key Rotation Automation (2026-08-17)|18. Phase 11E: Continuous Reliability, Automated Drift Detection & Key Rotation Automation (2026-08-17)]]
...
1. `PrismaService` - 194 edges
2. `DuffelService` - 75 edges
3. `NestJSClient` - 67 edges
4. `CacheService` - 57 edges
...
- `mock_nestjs_client()` --indirect_call--> `NestJSClient`  [INFERRED]
  apps/agent/tests/test_rollback_matrix.py → apps/agent/src/agent/tools/nestjs_client.py
- `test_nestjs_client_post_gateway_flights_search_v2_handles_400_error()` --calls--> `NestJSClient`  [INFERRED]
  apps/agent/tests/test_search_snapshot.py → apps/agent/src/agent/tools/nestjs_client.py
- `test_nestjs_client_search_flights_v2_alias()` --calls--> `NestJSClient`  [INFERRED]
  apps/agent/tests/test_search_snapshot.py → apps/agent/src/agent/tools/nestjs_client.py
...
## Communities (570 total, 159 thin omitted)

### Community 0 - "NestJSClient"
Cohesion: 0.13
Nodes (12): Settings, Resolves the original user message from body or graph state., _resolve_user_message(), test_output_guardrail_config_custom(), test_output_guardrail_config_defaults(), test_session_lock_timing_defaults_and_override(), test_agent_config_defaults(), test_agent_config_flag_matrix_combinations() (+4 more)
...
Cohesion: 0.09
Nodes (18): AuthenticatedRequest, BookingHandoffController, AuthenticatedRequest, ChatHandoffController, ChatHandoffSafeResolveResponse, firstFlightSegment(), handoffPassengers(), isJsonRecord() (+10 more)
...
Cohesion: 0.12
Nodes (17): 1.1 Architecture & Component Boundaries, 1.2 Component Responsibilities & Decision Boundaries, 1. System Topology and Decision Ownership, 2.1 Configuration Variables, 2.2 Rollout Stages & Migration Sequence, 2.3 Flag State Matrix, 2. Feature Flags and Rollout Matrix, 3.1 Failure Modes & Recovery Matrix (+9 more)
...
Cohesion: 0.03
Nodes (48): AppModule, LockoutService, CacheService, HttpExceptionFilter, mockOffersGet, mockOffersGetPriced, mockSeatMapsGet, DuffelCleanupService (+40 more)
...
Cohesion: 0.13
Nodes (22): fetchBrowserProfile(), requestBrowserProfile(), updateBrowserProfile(), ErrorBody, getProfileRequestError(), isErrorBody(), ProfileContactUpdate, ProfileDocumentUpdate (+14 more)
...
Cohesion: 0.14
Nodes (17): BookingReadinessService, currentDateOnly(), dateOnlyFromRaw(), httpError(), iataFromRaw(), inlinePassenger(), isRecord(), isValidDateOnly() (+9 more)

### Community 70 - "auth.spec.ts"
Cohesion: 0.10
Nodes (20): BookingReadinessConfig, BookingReadinessConfigEnv, clampPassportAdvisoryBufferDays(), parseBookingReadinessConfig(), BookingReadinessEvaluator, normalizedDocumentTypes(), createInput(), createPassenger() (+12 more)
...
### Community 79 - "agent"
Cohesion: 0.15
Nodes (8): AuthenticatedRequest, CommitBaggageDto, CommitSeatDto, JwtAuthGuard, AuthenticatedRequest, HandoffFastFailGuard, HandoffRequest, RequestFixture
...
Cohesion: 0.06
Nodes (13): BookingService, parseDuffelCancellationQuoteId(), serializeDuffelCancellationQuoteId(), DuffelService, input, Pricing, AncillaryPaymentValidationService, LeasedSnapshot (+5 more)
...
Cohesion: 0.20
Nodes (6): Roles(), RolesGuard, BackfillOptionsDto, PassportExpiryBackfillController, BackfillResult, PassportExpiryBackfillService
...
Cohesion: 0.08
Nodes (25): OutputGuardrailConfig, OutputGuardrailBlockedError, OutputGuardrailPipeline, Feeds a token into the pipeline, yielding any safe completed chunks., Raised when an output chunk fails safety validation., Orchestrates output safety validation using a layered pipeline., Flushes the remaining buffered tokens and validates the final chunk., Cancels and cleans up any background validation tasks. (+17 more)
...
Cohesion: 0.21
Nodes (4): BookingIntentController, BookingIntentLegacyController, setSafeHeaders(), GetBookingIntentResponseDto
...
Cohesion: 0.19
Nodes (28): addDaysToParsedDate(), buildPassengerResult(), compareParsedDates(), determineScope(), evaluateContactSection(), evaluateCountryField(), evaluateDateOfBirth(), evaluateDocumentType() (+20 more)
...
Cohesion: 0.31
Nodes (5): capitalizeCabinClass(), cleanIsoTime(), formatDuffelBaggageAllowance(), parseISODurationToMinutes(), FlightSearchResponseDto
...
Cohesion: 0.11
Nodes (12): HasValidHandoffSource(), CanonicalPassengerMetadataConstraint, CanonicalPassengerShapeConstraint, CreateIntentPassengerDto, InlinePassengerSourceDto, LEGACY_PASSENGER_FIELDS, LEGACY_REQUIRED_PASSENGER_FIELDS, missingLegacyPassengerFields() (+4 more)
...
Cohesion: 0.08
Nodes (13): BookingAgentProjectionService, SafeBookingProjectionData, BookingWithRelations, AuthenticatedRequest, DisruptionController, ReconciliationResult, DbSegment, PrismaError (+5 more)

### Community 255 - "devDependencies"
Cohesion: 0.19
Nodes (6): AuthenticatedRequest, AgentApiKeyGuard, AttestedFlightSearchDto, AttestedFlightSearchResponseDto, AttestedFlightSearchResultDto, FlightSearchQueryDto
...
Cohesion: 0.23
Nodes (6): BookingPassengerFinalValidatorService, formatDateOnly(), isRecord(), isValidDateOnly(), safeMetadata(), sanitizeIdentifier()
...
Cohesion: 0.30
Nodes (8): MockBookingDetailResponse, BookingFailureReason, BookingStatus, BookingDetailDto, BookingListItemDto, CancellationQuoteResponseDto, CancellationResponseDto, PassengerSnapshot
...
Cohesion: 0.17
Nodes (6): AuthController, AuthenticatedRequest, AuthModule, AuthService, LoginDto, RegisterDto
...
Cohesion: 0.14
Nodes (3): AgentGatewayController, AgentGatewayService, BookingSummariesResponseDto
...
Cohesion: 0.12
Nodes (11): Chatbot Booking Orchestration, Flight Booking System, Language, Further Notes, Implementation Decisions, Out of Scope, Problem Statement, Product Requirements Document: Disruption & Flight-Change Management (+3 more)
...
Cohesion: 0.21
Nodes (7): handler, MOCK_BOOKINGS, BookingDetailResponse, Props, BookingConfirmationBanner(), BookingConfirmationBannerProps, authOptions
...
Cohesion: 0.18
Nodes (18): AgentGatewayModule, AirportsModule, AncillariesModule, envSchema, AuditModule, BookingModule, BookingIntentModule, CacheModule (+10 more)

### Community 327 - "paths"
Cohesion: 0.04
Nodes (45): OwnedIntent, AncillaryCatalogService, AuditService, enrichRedactedDuffelOrder(), StripeService, DuffelConfirmedCancellation, DuffelRecoveredOrder, ConfirmPaymentDto (+37 more)
...
Cohesion: 0.29
Nodes (7): Decisions, Failure classification, Optimistic claims, not long database locks, Refund idempotency expiry, Remote-first crash recovery, Supplier-first cancellation, Two-tier retry policy

### Community 341 - "Implementation Plan: Disruption & Flight-Change Management"
Cohesion: 0.08
Nodes (24): Complexity Tracking, Constitution Check — Post-Design Re-evaluation, Constitution Check — Pre-Design Gate, Dependency and delivery map, Exit criteria, Exit criteria, Exit criteria, Feature documentation (+16 more)

### Community 342 - "Grilling Session — Feature 14: Disruption & Flight-Change Management"
Cohesion: 0.10
Nodes (25): Action, ACTIONS, BookingActionCard(), BookingActionCardProps, FIELD_LABELS, FIELD_NAMES, FieldName, getReasonBanner() (+17 more)
...
Cohesion: 0.29
Nodes (7): Assumptions, Feature Specification: Traveler Profile & Booking Readiness, Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)*
...
Cohesion: 0.11
Nodes (22): TrustedSearchResult, TrustedSearchSnapshot, Test atomic replace and load with correct owner/session., Test atomic overwrite replaces the old snapshot entirely., Test that snapshot is saved with the correct TTL based on expiresAt., Test that a valid schema parses successfully., Test that schema version other than 1 is rejected., Test that unknown/forbidden fields are rejected. (+14 more)
...
Cohesion: 0.22
Nodes (5): Redis, Atomically replaces the old snapshot and sets the TTL based on expiresAt., Loads the snapshot and verifies owner/session match., Atomically delete the snapshot., TrustedSnapshotRepository
...
Cohesion: 0.10
Nodes (22): Request, Response, ChatStreamRequest, Request model for the chat stream endpoint., detect_pii(), Detects if the input text contains Passport numbers, Credit card numbers (Luhn c, chat_stream(), Request (+14 more)
...
Cohesion: 0.05
Nodes (27): AirportsService, ALLOWED_METADATA_KEY_SET, BookingReadinessObservability, BookingReadinessObservabilityEvent, EncryptionService, BOOKING_READINESS_METRIC_COUNTERS, BookingReadinessHealthSnapshot, BookingReadinessMetricCounter (+19 more)
...
Cohesion: 0.21
Nodes (11): SafeActionRequiredEvent, ChatWidgetInner(), consumeChatStream(), ConsumeChatStreamOptions, consumeSseBlock(), getSafeOfferId(), getSafeSessionId(), CheckoutHandoffCard() (+3 more)
...
Cohesion: 0.04
Nodes (47): SelectionAttestationOffer, SelectionAttestationPayload, SelectionAttestationService, ActiveUser, JwtPayload, ValidatedUser, ClaimedHandoffForIntent, HandoffFastFailReservation (+39 more)
...
Cohesion: 0.10
Nodes (19): actionHandoffSchema, ActionRequiredEvent, BaseSSEEvent, BookingDetail, BookingSummary, ChatEvent, ChatMessageEvent, HandoffError (+11 more)
...
Cohesion: 0.18
Nodes (14): ActionRequiredEvent, BaseSSEEvent, ChatMessageEvent, DisplayInfo, HandoffEvent, test_accepts_valid_handoff_event(), test_rejects_handoff_event_extra_fields(), test_rejects_handoff_event_missing_token() (+6 more)
...
Cohesion: 0.11
Nodes (6): Any, Calls service-authenticated NestJS access check POST /api/agent-gateway/chat/acc, RunnableConfig, Search for available flights between two airports on a specific date. Returns th, search_flights(), ValueError
...
Cohesion: 0.08
Nodes (13): CABIN_KEYWORDS, PASSENGER_KEYWORDS, AgentBookingReadinessPassengerDto, AgentBookingReadinessRequestDto, AgentBookingReadinessResponseDto, ChatMessageCryptoService, CryptoKeyUnavailableError, UnsupportedKeyVersionError (+5 more)
...
Cohesion: 0.15
Nodes (16): _persist_response(), Persists the user and agent messages as a batch.     Revalidates active fence i, make_token(), Chaos Simulation: RateLimitMiddleware fails closed with 503 CHAT_CONTROL_PLANE_U, Chaos Simulation: If Redis drops mid-stream during background session lock refre, Chaos Simulation: When client abruptly disconnects during streaming (asyncio.Can, Chaos Simulation: validate_active_fence prevents stale turn persistence     when, Chaos Simulation: When disconnect occurs and partial response exists with VALID (+8 more)
...
Cohesion: 0.28
Nodes (8): BookingIntentContactSummaryDto, BookingIntentCreationPassengerDto, BookingIntentDocumentSummaryDto, BookingIntentFlightDto, BookingIntentPassengerDetailDto, BookingIntentPassengerSummaryDto, BookingIntentPrefillPassengerDto, CreateBookingIntentResponseDto
...
Cohesion: 0.40
Nodes (5): BookingFailureState(), BookingFailureStateProps, chargeMessage(), failureMessages, FlightSnapshot
...
Cohesion: 0.06
Nodes (29): Advisory readiness, Agent-gateway projection, API Contract: Traveler Profile & Booking Readiness, Authoritative intent creation, Final order boundary, `GET /api/bookings/intents/:id`, `GET /api/profile`, Legacy `useProfile` compatibility (+21 more)
...
Cohesion: 0.06
Nodes (31): PassengerDetail, AncillaryBaggageSelection, AncillaryCabin, AncillaryCabinClass, AncillaryCacheStatus, AncillaryCatalog, AncillaryErrorCode, AncillaryErrorResponse (+23 more)
...
### Community 469 - "PassengerFormClient.tsx"
Cohesion: 0.24
Nodes (6): PassengerPageFlightDetail, Props, FormPassenger, PassengerFormClient(), PassengerFormClientProps, TravelerProfileResponse

### Community 471 - "CreateIntentDto"
Cohesion: 0.24
Nodes (4): assertCanonicalCreate(), requestContext(), CreateIntentDto, validationErrors()
...
Cohesion: 0.22
Nodes (3): AncillariesController, AncillariesService, CommitAncillarySelectionDto

### Community 489 - "CheckoutHandoffCard.tsx"
Cohesion: 0.20
Nodes (6): EncryptionContext, InlinePassengerSource, PassengerSource, PassengerSourceRequest, ProfileRecord, TravelerProfilePassengerSource
...
### Community 493 - "17. Phase 11D: Post-Rollout Decommissioning, Direct-Only Architecture Lockdown & Final Cryptographic Sign-Off (2026-08-17)"
Cohesion: 0.40
...
### Community 497 - "index.ts"
Cohesion: 0.33
Nodes (3): BookingDetailDto, BookingSummaryDto, FlightResultDto
...
Cohesion: 0.28
Nodes (7): MaskedPassengerSummary, PassengerSnapshotBuildInput, PassengerSnapshotBuildResult, ResolvedPassengerForSnapshot, SnapshotScope, internationalPassenger(), passenger()

### Community 502 - "profile.controller.ts"
Cohesion: 0.31
Nodes (6): ContactSectionDto, IdentitySectionDto, PreferencesSectionDto, TravelDocumentSectionDto, UpdateProfileDto, AuthenticatedRequest

### Community 503 - "project_snapshot_results"
Cohesion: 0.25
Nodes (8): project_snapshot_results(), Any, Project the trusted snapshot into the exact browser-safe result shape., Verify TrustedSearchSnapshot serialization and projection 100% strips private of, test_trusted_snapshot_serialization_and_projection_zero_leakage(), Verify project_snapshot_results never returns offer IDs or provider IDs to the b, test_project_snapshot_results_excludes_identifiers(), test_project_snapshot_results_is_identifier_free()
...
### Community 505 - "Design Decisions"
Cohesion: 0.25
...
### Community 506 - "test_phase8c_privacy.py"
Cohesion: 0.29
Nodes (6): Verify that SSE error payloads contain standard error codes and scrubbed message, Verify that pii_scrubber detects and scrubs email, phone, passport, and card., Verify _SAFE_LLM_FIELDS does not contain local offer IDs, Duffel offer IDs, or d, test_pii_scrubber_redacts_seeded_corpus(), test_safe_llm_fields_excludes_identifiers(), test_sse_error_payloads_contain_zero_pii_or_tokens()

### Community 507 - "booking-intent.service.spec.ts"
Cohesion: 0.29
Nodes (6): CanonicalPrismaMock, MockAuditService, MockDuffelService, MockEncryptionService, MockPrismaService, TestableService

### Community 509 - "User Scenarios & Testing *(mandatory)*"
Cohesion: 0.29
Nodes (7): Edge Cases, User Scenarios & Testing *(mandatory)*, User Story 1 - Maintain a Booking-Ready Profile (Priority: P1), User Story 2 - Check Readiness Before Booking (Priority: P2), User Story 3 - Create an Intent From Explicit Passenger Sources (Priority: P3), User Story 4 - Complete Readiness From Chat Without Sharing PII (Priority: P4), User Story 5 - Enforce Final Passenger Safety (Priority: P5)

### Community 511 - "ItineraryChangeSummary.tsx"
Cohesion: 0.33
Nodes (4): ItineraryChangeSummary(), ItineraryChangeSummaryProps, PresentationSummary, SliceSummary

### Community 514 - "profile-response.dto.ts"
Cohesion: 0.40
...
### Community 515 - "4. Dashboards and Telemetry Metrics"
Cohesion: 0.40
Nodes (5): 4.1 Standardized Prometheus Metrics, 4.2 Latency SLAs and Performance Benchmarks, 4.3 Grafana Dashboard Layout, 4. Dashboards and Telemetry Metrics, Measured Gate Results (T075 Benchmark Evidence - 2026-08-18)

### Community 516 - "6. Incident Response and Playbooks"
Cohesion: 0.40
Nodes (5): 6. Incident Response and Playbooks, Playbook A: Investigating and Remediating Snapshot Integrity Failures, Playbook B: Passport Expiry Backfill Quarantine Spike and Manual Recovery, Playbook C: Duffel Order Rejection or Live Clock Expiry During Final Validation, Playbook D: High CAS Revision Conflicts During Concurrent Profile Updates

### Community 517 - "8. Cryptographic and Negative PII Security Invariants"
Cohesion: 0.50
Nodes (4): 8.1 Record-Bound AAD Contexts, 8.2 Decrypt-Then-Validate Order, 8.3 Zero Plaintext PII Invariants, 8. Cryptographic and Negative PII Security Invariants

### Community 518 - "18. Phase 11E: Continuous Reliability, Automated Drift Detection & Key Rotation Automation (2026-08-17)"
Cohesion: 0.50
...
Cohesion: 0.15
Nodes (13): BookingIntentForValidation, BookingIntentPassengerRecord, DecryptedPassenger, DuffelIdentityDocument, DuffelPassengerDto, FinalPassengerValidationOptions, FinalPassengerValidationResult, ENCRYPTION_KEY (+5 more)
...
Cohesion: 0.11
Nodes (22): AncillariesPage(), Props, PaymentPage(), Props, Props, ReviewPage(), SearchPage(), LogoutButton() (+14 more)
...
## Knowledge Gaps
- **2917 isolated node(s):** `root`, `parser`, `plugins`, `extends`, `node` (+2912 more)
...
- **What connects `root`, `parser`, `plugins` to the rest of the system?**
  _3107 weakly-connected nodes found - possible documentation gaps or missing edges._
