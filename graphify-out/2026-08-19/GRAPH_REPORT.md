...
## Corpus Check
- 761 files · ~575,271 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6331 nodes · 9766 edges · 557 communities (405 shown, 152 thin omitted)
...
## Communities (557 total, 152 thin omitted)
...
Cohesion: 0.16
Nodes (14): FlightConditionChangeBeforeDepartureDto, FlightConditionsDto, FlightDetailResponseDto, CabinMismatchDetail, FlightOfferDto, FlightSearchRequestDto, FlightSearchResponseDto, FlightSearchResponseMetaDto (+6 more)
...
Cohesion: 0.06
Nodes (31): envSchema, HandoffFastFailGuard, HandoffRequest, RequestFixture, AuthenticatedRequest, BookingHandoffController, AuthenticatedRequest, ChatHandoffController (+23 more)
...
Cohesion: 0.04
Nodes (35): SafeBookingProjectionData, AppModule, HttpExceptionFilter, DuffelCleanupService, DuffelConfirmedCancellation, DuffelRecoveredOrder, DuffelService, DuffelTimeoutError (+27 more)
...
Cohesion: 0.15
Nodes (11): PassengerPageFlightDetail, Props, FormPassenger, PassengerFormClient(), PassengerFormClientProps, BookingReadinessResponse, CheckoutPassengerRequest, ALLOWED_RETURN_PREFIXES (+3 more)
...
Cohesion: 0.06
Nodes (39): BookingDetail(), BookingDetailProps, currencyFormatter(), BookingProcessingState(), BookingStatus, BookingStatusBadge(), BookingStatusBadgeProps, statusLabels (+31 more)
...
Cohesion: 0.13
Nodes (3): RefundPaymentDto, enrichRedactedDuffelOrder(), redactDuffelOrder()
...
Cohesion: 0.06
Nodes (23): AuthController, AuthenticatedRequest, AuthModule, AuthService, LoginDto, RegisterDto, LockoutService, JwtStrategy (+15 more)
...
Cohesion: 0.09
Nodes (11): Roles(), RolesGuard, ConfirmPaymentDto, CreatePaymentDto, PaymentResponseDto, AuthenticatedRequest, PaymentController, IdempotencyKey (+3 more)
...
Cohesion: 0.06
Nodes (58): BookingReadinessConfig, BookingReadinessConfigEnv, clampPassportAdvisoryBufferDays(), parseBookingReadinessConfig(), addDaysToParsedDate(), BookingReadinessEvaluator, buildPassengerResult(), compareParsedDates() (+50 more)

### Community 173 - "chat_stream"
Cohesion: 0.11
Nodes (11): BookingReadinessInlineSourceDto, BookingReadinessPassengerSourceConstraint, BookingReadinessPassengerSourceDto, BookingReadinessTravelerProfileSourceDto, HandoffSourceConstraint, hasOnlyKeys(), INLINE_SOURCE_KEYS, isRecord() (+3 more)
...
Cohesion: 0.14
Nodes (12): ProfileResponseContactDto, ProfileResponseDto, ProfileResponseIdentityDto, ProfileResponsePreferencesDto, ProfileResponseTravelDocumentDto, ContactSectionDto, IdentitySectionDto, PreferencesSectionDto (+4 more)
...
Cohesion: 0.05
Nodes (22): BookingAgentProjectionService, AuthenticatedRequest, DisruptionController, TravellerDisruptionController, DisruptionService, DbSegment, PrismaError, SupplierSyncService (+14 more)
...
Cohesion: 0.07
Nodes (15): AuthenticatedRequest, BookingController, BookingService, BookingWithRelations, enrichRedactedDuffelOrder(), parseDuffelCancellationQuoteId(), serializeDuffelCancellationQuoteId(), BookingListQueryDto (+7 more)
...
Cohesion: 0.11
Nodes (18): DuffelAircraft, DuffelAirline, DuffelBaggage, DuffelBaggageMetadata, DuffelOffer, DuffelOfferAvailableService, DuffelOfferWithServices, DuffelPassenger (+10 more)
...
Cohesion: 0.21
Nodes (18): AgentGatewayModule, AirportsModule, AncillariesModule, AuditModule, BookingModule, BookingIntentModule, CacheModule, ChatModule (+10 more)

### Community 327 - "paths"
Cohesion: 0.11
Nodes (22): AuditService, StripeService, LeasedSnapshot, ValidateAncillaryPaymentInput, ValidatedAncillaryPayment, ValidationIntent, dto, validated (+14 more)
...
Cohesion: 0.08
Nodes (34): classOptions, countryOptions, documentOptions, genderOptions, getMaskedPassport(), phoneCountryOptions, ProfileDraft, ProfileSection (+26 more)
...
Cohesion: 0.07
Nodes (19): CABIN_KEYWORDS, PASSENGER_KEYWORDS, AgentBookingReadinessPassengerDto, AgentBookingReadinessRequestDto, AgentBookingReadinessResponseDto, ChatMessageCryptoService, CryptoKeyUnavailableError, UnsupportedKeyVersionError (+11 more)

### Community 358 - "route.ts"
Cohesion: 0.20
Nodes (13): handler, GET(), getAccessToken(), jsonError(), mapProfileError(), PATCH(), ProfilePage(), authOptions (+5 more)
...
Cohesion: 0.04
Nodes (47): ClaimedHandoffForIntent, HandoffFastFailReservation, LegacyIntentPassenger, ResolvedIntentPassenger, BookingIntentForValidation, BookingIntentPassengerRecord, DecryptedPassenger, DuffelIdentityDocument (+39 more)
...
Cohesion: 0.09
Nodes (22): 1. Pure evaluator, orchestration outside, 2. Canonical plural contract with compatibility window, 3. Additive passport-expiry protection, 4. Revision-bound source and immutable snapshot, 5. Chat is metadata-only, 6. Unknown-scope mapping, 7. Final validation inside the existing single-owner pipeline, Bite-Sized Delivery Phases (+14 more)
...
Cohesion: 0.13
Nodes (15): metadata, SafeActionRequiredEvent, ChatWidget(), ChatWidgetInner(), consumeChatStream(), ConsumeChatStreamOptions, consumeSseBlock(), getSafeOfferId() (+7 more)
...
Cohesion: 0.06
Nodes (27): SelectionAttestationOffer, SelectionAttestationPayload, SelectionAttestationService, ALLOWED_METADATA_KEYS, ALLOWED_STRING_VALUES, BOOLEAN_METADATA_KEYS, CHAT_HANDOFF_OBSERVABILITY_CONTRACT, ChatTelemetryEvent (+19 more)
...
Cohesion: 0.25
Nodes (6): capitalizeCabinClass(), cleanIsoTime(), formatDuffelBaggageAllowance(), parseISODurationToMinutes(), FlightResultDto, FlightSearchResponseDto
...
Cohesion: 0.07
Nodes (30): 10. Privacy rules and operator closeout, 11. Phase 11A: Production Rollout, Live Health & Operational Verification (2026-08-16), 13.1 Agent Privacy Scanner (`apps/agent/tests/test_negative_privacy_audit.py`), 13.2 API E2E Privacy Scanner (`apps/api/test/negative-privacy-audit.e2e-spec.ts`), 13. Continuous Negative Privacy & Security Automated Audit (Task C), 14.1 Agent Chaos Simulation (`apps/agent/tests/test_chaos_simulation.py`), 14.2 API Chaos Incident Drills (`apps/api/test/chaos-incident-drills.e2e-spec.ts`), 14. Chaos & Fault-Tolerance Incident Drills (Task B) (+22 more)
...
Cohesion: 0.21
Nodes (4): BookingDetailDto, BookingSummariesResponseDto, BookingSummaryDto, UserPreferencesDto
...
Cohesion: 0.08
Nodes (7): CacheService, mockOffersGet, mockOffersGetPriced, mockSeatMapsGet, AgentHealthResult, AgentHealthService, HealthController
...
Cohesion: 0.16
Nodes (7): CanonicalPrismaMock, MockAuditService, MockDuffelService, MockEncryptionService, MockPrismaService, TestableService, PassengerSourceResolverService
...
Cohesion: 0.06
Nodes (32): Advisory readiness, Agent-gateway projection, API Contract: Traveler Profile & Booking Readiness, Authoritative intent creation, Final order boundary, `GET /api/bookings/intents/:id`, `GET /api/profile`, Legacy `useProfile` compatibility (+24 more)
...
Cohesion: 0.29
Nodes (7): 10.1 Safe Rollback Decision Matrix, 10.2 Graceful Degradation to Legacy Checkout, 10. Emergency Rollback Procedures, 1.1 Production Request and Data Flow, 1.2 Component Responsibility & Decision Ownership, 1. System Topology and Decision Ownership, Traveler Profile & Booking Readiness Operations Runbook
...
Cohesion: 0.60
Nodes (5): capitalize(), computeCabinMatch(), mapOffer(), mapSegment(), parseISO8601Duration()
...
Cohesion: 0.06
Nodes (25): AncillariesController, AncillariesService, OwnedIntent, AncillaryCatalogService, assertCurrency(), calculateAncillaryTotals(), formatCents(), parseCents() (+17 more)
...
Cohesion: 0.40
Nodes (5): 2.1 Feature Flags Specification, 2.2 Controlled 5-Step Rollout Order, 2.3 Invalid & Unsafe Configuration Combinations, 2.4 Instant Emergency Rollback, 2. Feature Flags and Rollout Order
...
Cohesion: 0.67
Nodes (3): 11.1 Automated Test Suite Verification, 11.2 Operational Sign-Off Invariant, 11. Verification & Compliance Sign-Off

### Community 503 - "4. Dashboards and Alert Rules"
Cohesion: 0.67
Nodes (3): 4.1 Grafana Operational Dashboard Panels, 4.2 Standard Alert Rules & Thresholds, 4. Dashboards and Alert Rules
...
Cohesion: 0.67
Nodes (3): 5.1 Measured Latency Gates (100 Warmed Requests), 5.2 Concurrency & Race Condition Verification, 5. Performance and Concurrency Baselines

### Community 506 - "9. Privacy & Cryptographic Invariants"
Cohesion: 0.67
Nodes (3): 9.1 Record-Bound AES-256-GCM Context Invariants, 9.2 Masked Summary Projections, 9. Privacy & Cryptographic Invariants
...
## Knowledge Gaps
- **2933 isolated node(s):** `root`, `parser`, `plugins`, `extends`, `node` (+2928 more)
